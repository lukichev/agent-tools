...
Modern Python 3.10+ patterns and best practices. Import this into your project's `CLAUDE.md` with `@guides/python.md`, then add project-specific sections below.
